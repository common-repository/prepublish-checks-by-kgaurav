...
function prevent_post_publishing($post_id, $post)
{
    ...
    // You can also add a post type verification here,
        ...
        <form method="post" action="options.php">
            ...
            <table>
                <tr style="background:rgba(255, 99, 71, 0.5);">
                    ...
                    <td><input type="text" name="prepublish_checks_by_kgaurav_settings_data[titlemin]" value="<?php echo esc_attr($prepublish_checks_by_kgaurav_settings_data['titlemin']); ?>" /></td>
                </tr>
                <tr style="background:#bebebe;">
                    <th scope="row"><label>Title Max Length(default 280):</label></th>
                    <td><input type="text" name="prepublish_checks_by_kgaurav_settings_data[titlemax]" value="<?php echo esc_attr($prepublish_checks_by_kgaurav_settings_data['titlemax']); ?>" /></td>
                </tr>
                <tr style="background:rgba(255, 99, 71, 0.5);">
                ...
                <tr style="background:rgba(255, 99, 71, 0.5);">
                    ...
                    <td><input type="text" name="prepublish_checks_by_kgaurav_settings_data[featuredimagewidth]" value="<?php echo esc_attr($prepublish_checks_by_kgaurav_settings_data['featuredimagewidth']); ?>" /></td>
                </tr>
                <tr style="background:#bebebe;">
                    ...
                    <td><input type="text" name="prepublish_checks_by_kgaurav_settings_data[featuredimageheight]" value="<?php echo esc_attr($prepublish_checks_by_kgaurav_settings_data['featuredimageheight']); ?>" /></td>
                </tr>
                <tr style="background:rgba(255, 99, 71, 0.5);">
                    ...
                    <td><input type="text" name="prepublish_checks_by_kgaurav_settings_data[featuredimagewidthmax]" value="<?php echo esc_attr($prepublish_checks_by_kgaurav_settings_data['featuredimagewidthmax']); ?>" /></td>
                </tr>
                <tr style="background:#bebebe;">
                    ...
                    <td><input type="text" name="prepublish_checks_by_kgaurav_settings_data[featuredimageheightmax]" value="<?php echo esc_attr($prepublish_checks_by_kgaurav_settings_data['featuredimageheightmax']); ?>" /></td>
                </tr>
            </table>
            <?php submit_button(); ?>
        </form>
